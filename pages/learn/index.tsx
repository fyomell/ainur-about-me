        ...
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              ...
              <div className="text-xs text-white/60">MULTI PAGE LESSON</div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-14 pt-10">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-soft backdrop-blur">
          ...
          <p className="mt-2 text-sm text-white/70">
            •PILIH BAB •NANTI BAB LAIN BISA DITAMBAH
          </p>

          <div className="mt-6 grid gap-6 md:grid-cols-2">
            <a
              href="/learn/solar-system/1"
              className="group rounded-3xl border border-white/10 bg-slate-950/30 p-5 shadow-soft hover:bg-slate-950/40"
            >
            ...
            <div className="rounded-3xl border border-white/10 bg-slate-950/30 p-5 shadow-soft">
              <div className="text-xs font-extrabold tracking-widest text-white/60">COMING NEXT</div>
              <div className="mt-2 text-xl font-black">BINTANG • GALAKSI • ALAM SEMESTA</div>
              <div className="mt-2 text-sm text-white/70">
                •NANTI KITA TAMBAH BAB 2 •BAB 3
              </div>
            </div>
          </div>
        </div>
